...
# From https://gist.github.com/moshekaplan/5106221#file-test_surf-py-L83
...
def match_images(img1, img2):
    """Given two images, returns the matches""" # (Hessian threshold, noOctaves, noOctaveLayers)
    detector1 = cv2.xfeatures2d.SURF_create(100, 5, 5, True, True)
    detector2 = cv2.xfeatures2d.SURF_create(100, 5, 5, True, True)
    print "test"
    ...
    raw_matches = matcher.knnMatch(desc1, trainDescriptors = desc2, k = 3) #2
